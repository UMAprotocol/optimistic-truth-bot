...
def resolve_market(symbol, target_datetime):
    """
    Resolves the market based on the ETH/USDT price data at the specified datetime.
    Args:
        symbol (str): The symbol for the trading pair.
        target_datetime (datetime): The datetime for which the price data is needed.
    Returns:
...
def main():
    ...
    target_datetime = datetime(2025, 6, 18, 8, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "ETHUSDT"
