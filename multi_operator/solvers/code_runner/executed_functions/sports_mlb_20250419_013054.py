...
RESOLUTION_MAP = {
    "SEA": "p2",  # Seattle Mariners maps to p2
...
def fetch_game_data(date):
    ...
    try:
        ...
        # Find the specific game between Seattle Mariners and Toronto Blue Jays
        for game in games:
...
def determine_resolution(game):
    ...
    logger.info(f"Game status: {status}, {home_team} {home_score} - {away_team} {away_score}")
