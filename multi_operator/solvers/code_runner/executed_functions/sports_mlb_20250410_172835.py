...
RESOLUTION_MAP = {
    ...
    "San Diego Padres": "p1",  # San Diego Padres win maps to p1
...
def determine_resolution(game):
    ...
    if status == "Final":
        ...
        if home_score > away_score:
            ...
            return RESOLUTION_MAP["San Diego Padres"]
...
def main():
    date = "2025-04-09"
    home_team = "OAK"  # Athletics abbreviation
    away_team = "SD"   # San Diego Padres abbreviation
