...
def check_price_dip_to_threshold(symbol, start_date, end_date, threshold):
    ...
    # Fetch price data
    data = fetch_price_data(symbol, start_ts, end_ts)
...
def main():
    """
    Main function to determine if Solana (SOLUSDT) dipped to $120 or below in May 2025.
    """
    symbol = "SOLUSDT"
    ...
    if result:
        print("recommendation: p2")  # Yes, it dipped to $120 or below
    else:
        print("recommendation: p1")  # No, it did not dip to $120 or below
