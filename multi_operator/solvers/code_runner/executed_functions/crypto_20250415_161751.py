...
def main():
    ...
    try:
        ...
        price1 = get_close_price_at_specific_time(date1, hour, minute, timezone_str, symbol)
        price2 = get_close_price_at_specific_time(date2, hour, minute, timezone_str, symbol)
