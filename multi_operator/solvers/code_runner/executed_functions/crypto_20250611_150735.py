...
def get_eth_price_change(date_str, hour=10, minute=0, timezone_str="US/Eastern"):
    """
    Fetches the percentage change for the ETHUSDT pair on Binance for the specified hour candle.
    ...
    logger.debug(f"Using Binance API endpoint: {api_url}")
