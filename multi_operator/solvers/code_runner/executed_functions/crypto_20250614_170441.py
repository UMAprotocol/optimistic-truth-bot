...
def get_eth_price_change():
    """
    Determines the price change of ETH/USDT for the specific 1-hour candle on June 14, 2025, 12 PM ET.
    """
    # Define the time for the query
    target_time = datetime(2025, 6, 14, 12, 0, 0, tzinfo=pytz.timezone('US/Eastern'))
