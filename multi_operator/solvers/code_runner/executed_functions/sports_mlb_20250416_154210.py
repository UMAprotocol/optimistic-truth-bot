...
RESOLUTION_MAP = {
    "Yankees": "p1",  # New York Yankees win
    "Royals": "p2",   # Kansas City Royals win
...
def determine_resolution(game):
    ...
    if status in ["Final"]:
        ...
        if home_score > away_score:
            return "p1" if home_team == "NYY" else "p2"
        elif away_score > home_score:
            return "p1" if away_team == "NYY" else "p2"
...
def main():
    ...
    """
    date = "2025-04-15"
    team1_name = "NYY"  # New York Yankees
    team2_name = "KCR"  # Kansas City Royals
