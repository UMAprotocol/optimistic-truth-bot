...
def resolve_market(symbol, target_datetime):
    """
    Determines the market resolution based on the price change of the symbol at the specified datetime.
    """
...
def main():
    ...
    target_datetime = datetime(2025, 6, 11, 4, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "ETHUSDT"
