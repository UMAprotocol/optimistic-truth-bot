...
if __name__ == "__main__":
    ...
    mlb_teams = get_data("MLB", "/Teams")
    if mlb_teams:
        print("MLB Teams data retrieved successfully.")
    else:
        print("Failed to retrieve MLB Teams data.")

    # Example: Get current exchange information from Binance
    exchange_info = get_data("BINANCE", "/exchangeInfo")
    if exchange_info:
        print("Binance Exchange Information retrieved successfully.")
    else:
        print("Failed to retrieve Binance Exchange Information.")