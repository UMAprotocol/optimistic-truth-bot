...
def resolve_market():
    ...
    """
    # Define the time for the 1-hour candle on June 13, 2025, 11 AM ET
    target_time = datetime(2025, 6, 13, 11, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    ...
    start_price = fetch_price_data("ETHUSDT", "1h", start_time_utc, start_time_utc + 60000)
    end_price = fetch_price_data("ETHUSDT", "1h", end_time_utc - 60000, end_time_utc)
