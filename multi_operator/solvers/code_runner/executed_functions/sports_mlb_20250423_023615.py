...
RESOLUTION_MAP = {
    "Colorado Rockies": "p2",  # Rockies win maps to p2
    "Kansas City Royals": "p1",  # Royals win maps to p1
...
def fetch_game_data(date):
    ...
    try:
        ...
        for game in games:
            if game['HomeTeam'] == 'COL' and game['AwayTeam'] == 'KC':
                return game
            elif game['HomeTeam'] == 'KC' and game['AwayTeam'] == 'COL':
                return game

        logger.warning(f"No matching game found for Colorado Rockies vs Kansas City Royals on {date}.")
        return None
