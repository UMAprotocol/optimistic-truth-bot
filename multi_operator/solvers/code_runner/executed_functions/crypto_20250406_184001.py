...
def main():
    # Define the symbol and dates based on the question
    symbol = "ETHUSDT"
    date1 = "2025-04-05"
    date2 = "2025-04-06"
    hour = 12
    ...
    try:
        ...
        print(f"Price on {date1} at {hour}:{minute} {timezone_str}: {price_1}")
        print(f"Price on {date2} at {hour}:{minute} {timezone_str}: {price_2}")
