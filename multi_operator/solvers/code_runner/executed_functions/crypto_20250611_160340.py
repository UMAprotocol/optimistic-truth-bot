...
def get_eth_price_change():
    """
    Determines the price change of ETHUSDT for the specific 1-hour candle on Binance.
    """
    # Define the specific date and time for the query
    target_datetime = datetime(2025, 6, 11, 11, 0, 0, tzinfo=pytz.timezone('US/Eastern'))
