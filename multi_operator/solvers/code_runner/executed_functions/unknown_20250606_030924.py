...
def get_game_result(date_str):
    ...
    for game in games:
        if game['HomeTeam'] == 'IND' and game['AwayTeam'] == 'OKC' or \
           game['HomeTeam'] == 'OKC' and game['AwayTeam'] == 'IND':
            if game['Status'] == 'Final':
                if game['HomeTeam'] == 'IND' and game['HomeTeamScore'] > game['AwayTeamScore']:
                    return "p2"  # Pacers win
                elif game['AwayTeam'] == 'IND' and game['AwayTeamScore'] > game['HomeTeamScore']:
                    return "p2"  # Pacers win
                else:
