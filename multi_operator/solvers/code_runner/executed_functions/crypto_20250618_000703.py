...
def get_solana_price_at_specific_time(date_str, hour=19, minute=0, timezone_str="US/Eastern"):
    """
    ...
    Args:
        ...
        hour: Hour in 24-hour format (default: 19 for 7 PM ET)
...
def main():
    ...
    date_str = "2025-06-17"  # June 17, 2025
    hour = 19  # 7 PM ET
    minute = 0  # 00 minutes
    
    try:
        open_price, close_price = get_solana_price_at_specific_time(date_str, hour, minute)
