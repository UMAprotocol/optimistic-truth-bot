...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 15, 2025, 7 PM ET.
    """
    percentage_change = get_btc_price_change("2025-06-15", 19, 0, "US/Eastern")
