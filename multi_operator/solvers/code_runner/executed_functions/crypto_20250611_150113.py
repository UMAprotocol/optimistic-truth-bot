...
def get_eth_price_change(symbol, target_datetime):
    """
    Calculates the percentage change in price for the specified symbol at the given datetime.
    """
...
def main():
    ...
    target_datetime_str = "2025-06-11 10:00:00"
    ...
    price_change = get_eth_price_change(symbol, target_datetime)
