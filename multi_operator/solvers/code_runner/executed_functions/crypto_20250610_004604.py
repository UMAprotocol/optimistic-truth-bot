...
def check_doge_price_threshold(start_date, end_date, threshold):
    """
...
def main():
    ...
    threshold = 0.40  # The price threshold to check
    
    # Check if Dogecoin reached the threshold in May 2025
    result = check_doge_price_threshold(start_date, end_date, threshold)
    
    # Print the result based on the check
    if result:
        print("recommendation: p2")  # Yes, Dogecoin reached $0.40 or higher
    else:
        print("recommendation: p1")  # No, Dogecoin did not reach $0.40
