...
def get_binance_price(symbol, start_time):
    ...
    Args:
        ...
        start_time (int): The start time of the candle in milliseconds since the epoch (UTC)
...
def resolve_market():
    ...
    """
    symbol = "BTCUSDT"
    target_date = datetime(2025, 6, 7, 15, 0, 0, tzinfo=pytz.timezone("US/Eastern"))  # June 7, 2025, 3 PM ET
