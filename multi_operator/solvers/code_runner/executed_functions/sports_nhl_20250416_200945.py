        ...
        for game in games:
            if game['HomeTeam'] == "VGK" or game['AwayTeam'] == "VGK":
                if game['HomeTeam'] == "CGY" or game['AwayTeam'] == "CGY":
                    logger.info(f"Found the game between Vegas Golden Knights and Calgary Flames")
                    return game
        logger.warning("No matching game found between Vegas Golden Knights and Calgary Flames.")
        return None
