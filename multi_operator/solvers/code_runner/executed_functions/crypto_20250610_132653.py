...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 10, 2025, at 7 AM ET.
    """
    price_change = get_btc_price_change("2025-06-10", 7, 0, "US/Eastern")
