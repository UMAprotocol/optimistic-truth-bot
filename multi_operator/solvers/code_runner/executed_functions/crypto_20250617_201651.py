...
def get_sol_price_at_specific_time(date_str, hour=15, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to handle the Solana price query for June 17, 2025, 3PM ET.
    """
    ...
    try:
        open_price, close_price = get_sol_price_at_specific_time(date_str, hour, minute, timezone_str)
