...
def resolve_market(symbol, target_datetime):
    """
    Resolves the market based on the open and close prices of the specified symbol at the given datetime.
    """
...
def main():
    ...
    """
    target_datetime = datetime(2025, 6, 19, 23, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "ETHUSDT"
