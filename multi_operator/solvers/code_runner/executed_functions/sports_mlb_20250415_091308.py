...
def fetch_game_data(date):
    ...
    try:
        ...
        logger.warning("No matching game found for the specified teams on the given date.")
        return None
...
def determine_resolution(game):
    ...
    return "p4"  # In case of any other status, it's too early to resolve

def main():
    """
    Main function to query MLB game data and determine the resolution.
    """
    date = "2025-04-14"  # Hardcoded date for the specific game in question
