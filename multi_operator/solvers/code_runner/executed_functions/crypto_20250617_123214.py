...
def get_solana_price_at_specific_time(date_str, hour=7, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to handle the Solana price query for June 17, 2025, 7 AM ET.
    """
    query_date = "2025-06-17"
    logger.info(f"Processing query for SOL/USDT prices on {query_date} at 7 AM ET")
    
    try:
        open_price, close_price = get_solana_price_at_specific_time(query_date)
