...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 16, 2025, at 8 AM ET.
    """
    try:
        price_change = get_btc_price_change("2025-06-16", 8, 0, "US/Eastern")
