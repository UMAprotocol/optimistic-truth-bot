...
def main():
    """
    Main function to determine if the ETH/USDT price went up or down on June 15, 2025 at 5 AM ET.
    """
    price_change = get_eth_price_change("2025-06-15", 5, 0, "US/Eastern")
