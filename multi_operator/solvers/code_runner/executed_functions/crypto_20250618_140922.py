...
def get_eth_price_at_specific_time(date_str, hour=9, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    ...
    event_hour = 9  # 9 AM ET

    try:
        # Get prices for the event date and time
        open_price, close_price = get_eth_price_at_specific_time(event_date, event_hour)
