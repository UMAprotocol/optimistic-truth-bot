...
def fetch_game_data(date):
    ...
    try:
        ...
        for game in games:
            if game['HomeTeam'] == 'CIN' and game['AwayTeam'] == 'BAL':
                return game
            elif game['HomeTeam'] == 'BAL' and game['AwayTeam'] == 'CIN':
                return game

        logger.warning("No matching game found for Cincinnati Reds vs Baltimore Orioles.")
        return None
...
def determine_resolution(game):
    ...
    if status == "Final":
        if home_score > away_score:
            winner = "Cincinnati Reds" if home_team == "CIN" else "Baltimore Orioles"
        else:
            winner = "Baltimore Orioles" if away_team == "BAL" else "Cincinnati Reds"
