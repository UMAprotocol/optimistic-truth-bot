...
def main():
    """
    Main function to determine if the ETH/USDT price went up or down on June 13, 2025, at 4 AM ET.
    """
    try:
        price_change = get_eth_price_change("2025-06-13", 4, 0, "US/Eastern")
