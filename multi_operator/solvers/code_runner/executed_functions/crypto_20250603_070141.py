...
def main():
    ...
    symbol = "BTCUSDT"
    interval = "1h"
    # Convert 2 AM ET to UTC for the date June 3, 2025
    et_timezone = pytz.timezone("US/Eastern")
    utc_timezone = pytz.utc
    local_time = et_timezone.localize(datetime(2025, 6, 3, 2, 0, 0))
    ...
    try:
        ...
        print("recommendation: p3")  # Unknown or 50-50 if error
