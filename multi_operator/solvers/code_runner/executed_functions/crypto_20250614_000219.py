...
def resolve_market(symbol, target_datetime):
    ...
    try:
        closing_price_start = fetch_price_data(symbol, "1h", start_time, start_time + 60000)  # 1 minute after start
        closing_price_end = fetch_price_data(symbol, "1h", end_time, end_time + 60000)  # 1 minute after end
...
def main():
    # Example: Resolve for Ethereum on June 13, 2025, 7 PM ET
    target_datetime = datetime(2025, 6, 13, 19, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "ETHUSDT"
