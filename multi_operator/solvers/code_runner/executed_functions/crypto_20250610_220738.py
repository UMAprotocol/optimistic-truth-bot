...
def get_btc_price_change(date_str, hour=17, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 10, 2025, at 5 PM ET.
    """
