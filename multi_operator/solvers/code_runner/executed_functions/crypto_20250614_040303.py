...
def main():
    """
    Main function to determine if the price of BTC/USDT was up or down at the specified time.
    """
    target_datetime = datetime(2023, 6, 13, 23, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "BTCUSDT"
