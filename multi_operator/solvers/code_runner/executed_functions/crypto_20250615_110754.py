...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 15, 2025, at 6 AM ET.
    """
    try:
        price_change = get_btc_price_change("2025-06-15", 6, 0, "US/Eastern")
