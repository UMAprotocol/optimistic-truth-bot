...
RESOLUTION_MAP = {
    "MIL": "p2",  # Milwaukee Brewers win maps to p2
    "SF": "p1",   # San Francisco Giants win maps to p1
...
def fetch_game_data(game_date):
    ...
    try:
        ...
        games = response.json()
        for game in games:
            if game['HomeTeam'] == 'SF' and game['AwayTeam'] == 'MIL':
                return game
            elif game['HomeTeam'] == 'MIL' and game['AwayTeam'] == 'SF':
                return game
        return None
