...
def resolve_market(data):
    """
    Resolves the market based on the change in price from the start to the end of the candle.
    """
...
def main():
    ...
    target_time = datetime(2025, 6, 10, 6, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
