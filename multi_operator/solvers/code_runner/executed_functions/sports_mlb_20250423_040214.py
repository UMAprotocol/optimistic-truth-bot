...
def fetch_game_data():
    ...
    try:
        ...
        for game in games:
            if game['HomeTeam'] == team1_name or game['AwayTeam'] == team1_name:
                if game['HomeTeam'] == team2_name or game['AwayTeam'] == team2_name:
                    return game
        return None
...
def determine_resolution(game):
    ...
    if status == "Final":
        ...
        if home_score > away_score:
            return RESOLUTION_MAP.get(home_team, "p4")
        elif away_score > home_score:
            return RESOLUTION_MAP.get(away_team, "p4")
        else:
            return "p3"  # Tie case
