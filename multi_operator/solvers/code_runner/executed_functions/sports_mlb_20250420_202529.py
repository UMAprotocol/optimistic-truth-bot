...
def fetch_game_data(api_key, date):
    ...
    Args:
        api_key: API key for the sports data service
    ...
    try:
        ...
        games = response.json()
        for game in games:
            if game['HomeTeam'] == 'BOS' and game['AwayTeam'] == 'CHW':
                return game
            elif game['HomeTeam'] == 'CHW' and game['AwayTeam'] == 'BOS':
                return game
        return None
