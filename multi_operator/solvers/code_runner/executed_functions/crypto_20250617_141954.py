...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 17, 2025, at 9 AM ET.
    """
    price_change = get_btc_price_change("2025-06-17", 9, 0, "US/Eastern")
