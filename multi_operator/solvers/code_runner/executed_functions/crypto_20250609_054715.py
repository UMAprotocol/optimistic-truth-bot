...
def fetch_binance_data(symbol, interval, start_time, end_time):
    ...
    try:
        ...
        data = response.json()
        if data:
            return data[0][4]  # Return the close price
...
def main():
    ...
    target_datetime = datetime.strptime("2025-06-09 03:30:00", "%Y-%m-%d %H:%M:%S")
    ...
    if close_price is None:
        ...
        print("recommendation: p2")  # Yes, price is greater than or equal to 225,000 USDT
    else:
        print("recommendation: p1")  # No, price is less than 225,000 USDT
