...
def resolve_market(symbol, target_time):
    """
    Resolves the market based on the price change of the cryptocurrency at the specified time.
    """
...
def main():
    ...
    target_time = datetime(2025, 6, 5, 1, 0)  # June 5, 2025, 1:00 AM ET
    symbol = "BTCUSDT"  # Bitcoin to USDT on Binance
