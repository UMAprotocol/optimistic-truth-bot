...
def main():
    ...
    try:
        ...
        logger.info(f"Close price for {symbol} at {target_date} {target_hour}:{target_minute} {timezone_str} is {close_price}")
        if close_price > 150:
            print("recommendation: p2")  # Yes, price is above $150
        else:
            print("recommendation: p1")  # No, price is not above $150
    except Exception as e:
