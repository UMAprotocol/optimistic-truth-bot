...
def fetch_game_data(date):
    ...
    try:
        ...
        for game in games:
            if game['HomeTeam'] == 'MIN' and game['AwayTeam'] == 'ANA':
                return game
            elif game['HomeTeam'] == 'ANA' and game['AwayTeam'] == 'MIN':
                return game

        logger.warning("No matching game found between Ducks and Wild on the specified date.")
        return None
