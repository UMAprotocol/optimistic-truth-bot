...
RESOLUTION_MAP = {
    ...
    "Miami Marlins": "p1",    # Miami Marlins win maps to p1
...
def determine_resolution(game):
    ...
    if status == "Final":
        if game['HomeTeamRuns'] > game['AwayTeamRuns']:
            winner = "Cincinnati Reds" if game['HomeTeam'] == "CIN" else "Miami Marlins"
        else:
            winner = "Miami Marlins" if game['HomeTeam'] == "CIN" else "Cincinnati Reds"
