...
def get_eth_price_at_specific_time(date_str, hour=12, minute=0, timezone_str="US/Eastern"):
    """
    ...
    try:
        ...
        if data:
            ...
            logger.info(f"Successfully retrieved price change percentage: {price_change_percentage}%")
...
def main():
    """
    Main function to handle the Ethereum price query for June 17, 2025, 12 PM ET.
    """
    try:
        ...
        price_change_percentage = get_eth_price_at_specific_time(date_str, hour, minute, timezone_str)
