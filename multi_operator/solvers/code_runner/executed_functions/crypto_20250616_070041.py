...
def get_eth_price_change(symbol, date_str, hour, timezone_str):
    """
    Calculates the percentage change for the ETH/USDT pair for the specified hour candle on the given date.
    """
...
def main():
    ...
    change_percent = get_eth_price_change(symbol, date_str, hour, timezone_str)
