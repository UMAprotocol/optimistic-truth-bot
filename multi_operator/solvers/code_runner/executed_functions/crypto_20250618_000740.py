...
def get_sol_usdt_price(date_str, hour=19, minute=0, timezone_str="US/Eastern"):
    """
    ...
    try:
        ...
        if data:
            ...
            logger.info(f"Successfully retrieved open and close prices: {open_price}, {close_price}")
...
def main():
    ...
    """
    try:
        # The specific date and time for the query
        date_str = "2025-06-17"
        hour = 19  # 7 PM ET
        minute = 0
        ...
        open_price, close_price = get_sol_usdt_price(date_str, hour, minute, timezone_str)
