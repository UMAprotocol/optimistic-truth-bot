...
def resolve_market():
    ...
    if player_points is None:
        ...
        print("recommendation: p2")  # Player scored more than 16.5 points, resolve to "Yes"
    else:
        print("recommendation: p1")  # Player did not score more than 16.5 points, resolve to "No"
