...
def fetch_game_data(date):
    ...
    try:
        ...
        for game_data in games:
            if game_data['HomeTeam'] == 'MIN' and game_data['AwayTeam'] == 'ANA':
                return game_data
            if game_data['HomeTeam'] == 'ANA' and game_data['AwayTeam'] == 'MIN':
                return game_data

        logger.warning("No matching game found between ANA and MIN on the specified date.")
        return None
...
def determine_resolution(game):
    ...
    if status == "Final":
        ...
        return RESOLUTION_MAP.get(winner_team, "p3")
