...
RESOLUTION_MAP = {
    "BOS": "p1",  # Boston Bruins maps to p1
...
def fetch_game_data(date, team1_abbr, team2_abbr):
    ...
    try:
        ...
        for game in games:
            if (game['HomeTeam'] == team1_abbr and game['AwayTeam'] == team2_abbr) or (game['HomeTeam'] == team2_abbr and game['AwayTeam'] == team1_abbr):
...
def main():
    ...
    """
    date = "2025-04-15"
    team1_abbr = "NJD"  # New Jersey Devils
    team2_abbr = "BOS"  # Boston Bruins
