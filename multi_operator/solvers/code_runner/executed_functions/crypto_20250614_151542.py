...
def get_btc_price_change(date_str, hour=10, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to determine if the BTC price went up or down on June 14, 2025, at 10 AM ET.
    """
    date_str = "2025-06-14"
    hour = 10
    minute = 0
