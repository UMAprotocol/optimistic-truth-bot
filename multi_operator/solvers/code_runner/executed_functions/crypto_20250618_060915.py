...
def main():
    """
    Main function to handle the Ethereum price query for June 18, 2025, 1 AM ET.
    """
    try:
        # Fetch the ETH/USDT prices for the specified date and time
        open_price, close_price = get_eth_price("2025-06-18", 1, 0, "US/Eastern")
        ...
        # Default to unknown/50-50 in case of any errors
