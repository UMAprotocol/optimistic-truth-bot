...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 17, 2025, at 2 AM ET.
    """
    percentage_change = get_btc_price_change("2025-06-17", 2, 0, "US/Eastern")
