...
def get_sol_usdt_price(date_str, hour=12, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    ...
    # Fetch the open and close prices for the specified time
    prices = get_sol_usdt_price(event_date, event_hour)
