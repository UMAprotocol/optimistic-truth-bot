...
def main():
    ...
    try:
        ...
        price_apr_15 = get_close_price_at_specific_time("2025-04-15", 12, 0, "US/Eastern", "ETHUSDT")
        price_apr_16 = get_close_price_at_specific_time("2025-04-16", 12, 0, "US/Eastern", "ETHUSDT")
