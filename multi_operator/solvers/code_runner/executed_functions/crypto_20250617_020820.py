...
def get_eth_price_change(date_str, hour=21, minute=0, timezone_str="US/Eastern"):
    """
    Fetches the percentage change for the ETH/USDT pair on Binance for the specified 1-hour candle.
