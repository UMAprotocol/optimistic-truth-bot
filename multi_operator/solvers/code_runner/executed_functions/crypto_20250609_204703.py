...
TRADING_PAIR_ID = "bzc9nzfmqkxr6fz1dbph7bdf9broyef6pnzesp7v5iiw"

def fetch_dexscreener_data(start_time, end_time):
    """
    Fetches the 1-minute candle data for Fartcoin/SOL from Dexscreener API.
...
def check_price_dip(candles, threshold=0.85):
    """
...
def main():
    ...
    candles = fetch_dexscreener_data(start_time_ms, end_time_ms)
