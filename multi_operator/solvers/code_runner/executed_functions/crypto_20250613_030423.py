...
def resolve_market(symbol, target_datetime):
    ...
    try:
        ...
        end_price = fetch_price_data(symbol, "1h", end_time_ms, end_time_ms + 60000)  # End of the hour
...
def main():
    # Example usage
    target_datetime = datetime(2025, 6, 12, 22, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "ETHUSDT"
