...
def get_btc_price_at_specific_time(date_str, hour=17, minute=0, timezone_str="US/Eastern"):
    """
    Fetches the BTC/USDT 1-hour candle open and close prices on Binance at a specific time on a given date.

    Args:
        date_str: Date in YYYY-MM-DD format
        hour: Hour in 24-hour format (default: 17 for 5 PM ET)
...
def main():
    """
    Main function to handle the resolution of the Bitcoin price market.
    """
    # Date and time for the event
    event_date = "2025-06-18"
    event_hour = 17  # 5 PM ET
