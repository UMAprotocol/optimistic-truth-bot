...
def convert_to_utc_timestamp(date_str, hour=0, minute=0, timezone_str="US/Eastern"):
...
def main():
    ...
    start_time = convert_to_utc_timestamp(date_str, hour, timezone_str=timezone_str)
    end_time = start_time + 3600000  # 1 hour later in milliseconds
    
    # Fetch the data for BTC/USDT
