...
def resolve_market():
    ...
    if player_points is None:
        print("recommendation: p1")  # No data or game not final, resolve to "No"
    elif player_points > points_needed:
        print("recommendation: p2")  # Player scored more than 15.5 points, resolve to "Yes"
    else:
        print("recommendation: p1")  # Player did not score more than 15.5 points, resolve to "No"
