...
def get_eth_price_change(date_str, hour=17, minute=0, timezone_str="US/Eastern"):
    """
    ...
    try:
        ...
        if data:
            ...
            logger.info(f"Successfully retrieved price change: {price_change_percentage}%")
...
def main():
    ...
    query_date = "2025-06-17"  # Date of interest
    
    logger.info(f"Processing query for Ethereum price change on {query_date}")
