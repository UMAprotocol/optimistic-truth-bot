...
def main():
    """
    Main function to fetch the SOL/USDT price data for June 19, 2025, 5AM ET and resolve the market.
    """
    symbol = "SOLUSDT"
    interval = "1h"
    # Convert 5AM ET to UTC timestamp
    et_timezone = pytz.timezone("US/Eastern")
    target_time = et_timezone.localize(datetime(2025, 6, 19, 5, 0, 0))
