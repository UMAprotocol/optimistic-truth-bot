...
def get_eth_price_change():
    """
    Determines the price change of ETH/USDT for the 1-hour candle starting at 9 AM ET on June 16, 2025.
    """
    # Define the time for the candle
    target_date = datetime(2025, 6, 16, 9, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
