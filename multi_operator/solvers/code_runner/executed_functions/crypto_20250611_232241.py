...
def get_eth_price_change(date_str, hour=18, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    ...
    date_str = "2025-06-11"  # Date of interest
    hour = 18  # 6 PM ET
    minute = 0  # Start of the hour

    try:
        price_change_percent = get_eth_price_change(date_str, hour, minute)
