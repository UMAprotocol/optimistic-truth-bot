...
def get_btc_price_change(date_str, hour=12, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down at the specified time.
    """
    date_str = "2025-06-16"  # Date of interest
    hour = 12  # Hour of interest
    timezone_str = "US/Eastern"  # Timezone of interest

    price_change_percent = get_btc_price_change(date_str, hour, timezone_str=timezone_str)
