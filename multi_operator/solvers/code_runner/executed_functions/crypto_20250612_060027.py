...
def resolve_market():
    ...
    target_datetime = datetime(2025, 6, 12, 1, 0, 0)  # June 12, 2025, 1 AM ET
    ...
    start_price = fetch_price_data("ETHUSDT", "1h", start_time_ms, start_time_ms + 60000)
    end_price = fetch_price_data("ETHUSDT", "1h", end_time_ms, end_time_ms + 60000)
