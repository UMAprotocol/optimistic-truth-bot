...
def get_eth_price_change(date_str, hour, minute, timezone_str):
    """
    Fetches the percentage change for the ETH/USDT pair on Binance for a specific hour candle.
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Proxy failed, error: {e}, falling back to primary endpoint")
