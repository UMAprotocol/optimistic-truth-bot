...
def main():
    ...
    """
    date_str = "2025-06-18"  # Date of the event
    hour = 5  # Hour of the event in ET
    timezone_str = "US/Eastern"  # Timezone of the event

    try:
        open_price, close_price = get_btc_price_at_specific_time(date_str, hour, 0, timezone_str)
