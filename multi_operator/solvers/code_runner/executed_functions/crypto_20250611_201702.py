...
def get_btcusdt_price_change(date_str, hour=15, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    ...
    event_hour = 15  # 3 PM ET
    event_minute = 0

    # Fetch the price change
    price_change = get_btcusdt_price_change(event_date, event_hour, event_minute)
