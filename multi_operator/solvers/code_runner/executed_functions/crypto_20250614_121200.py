...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 14, 2025, at 7 AM ET.
    """
    percentage_change = get_btc_price_change("2025-06-14", 7, 0, "US/Eastern")
