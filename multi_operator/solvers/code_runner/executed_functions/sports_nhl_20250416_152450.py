...
def fetch_game_data(date):
    ...
    try:
        ...
        for game_data in games:
            if game_data['HomeTeam'] == 'VGK' or game_data['AwayTeam'] == 'VGK':
                if game_data['HomeTeam'] == 'CGY' or game_data['AwayTeam'] == 'CGY':
                    logger.info(f"Found matching game: VGK vs CGY")
                    return game_data

        logger.warning("No matching game found between VGK and CGY on the specified date.")
        return None
