    ...
    try:
        ...
        for game in games:
            if game['HomeTeam'] == 'SEA' and game['AwayTeam'] == 'CIN':
                return game
            elif game['HomeTeam'] == 'CIN' and game['AwayTeam'] == 'SEA':
                return game

        logger.warning("No matching game found for Seattle Mariners vs. Cincinnati Reds on the specified date.")
        return None
...
def determine_resolution(game):
    ...
    if status == "Final":
        ...
        if winner == 'SEA':
            return RESOLUTION_MAP["Mariners"]
        elif winner == 'CIN':
