...
def get_btc_price_change(date_str, hour):
    """
    Determines the price change of BTC/USDT on Binance at a specific hour on a given date.
    """
...
def main():
    ...
    date_str = "2025-06-08"
    hour = 16  # 4 PM ET
    change_percent = get_btc_price_change(date_str, hour)
