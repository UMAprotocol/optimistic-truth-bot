...
def main():
    ...
    if player_stats:
        ...
        if points_scored > 30.5:
            print("recommendation: p2")  # Yes, scored more than 30.5 points
        else:
            print("recommendation: p1")  # No, did not score more than 30.5 points
    else:
        print("recommendation: p1")  # No game data found or player did not play
