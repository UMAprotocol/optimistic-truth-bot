...
def main():
    """
    Main function to determine if Solana reached $150 in April 2025.
    """
    result = check_solana_price_threshold("2025-04-01 00:00", "2025-04-30 23:59", 150)
    if result:
        print("recommendation: p2")  # Yes, Solana reached $150
    else:
        print("recommendation: p1")  # No, Solana did not reach $150
