...
def main():
    """
    Main function to determine if the ETH/USDT price went up or down on June 14, 2025 at 5 PM ET.
    """
    date_str = "2025-06-14"  # Specific date for the query
    price_change = get_eth_price_change(date_str)
