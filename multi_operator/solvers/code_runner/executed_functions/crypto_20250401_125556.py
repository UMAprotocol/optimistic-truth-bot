...
def main():
    ...
    # Fetch prices
    try:
        price_1 = get_close_price_at_specific_time(symbol, date1)
        price_2 = get_close_price_at_specific_time(symbol, date2)
        ...
        print(f"Price on {date1} at 12:00 ET: {price_1}")
        print(f"Price on {date2} at 12:00 ET: {price_2}")
