...
def get_btc_price_change(date_str, hour=11, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 12, 2025, at 11 AM ET.
    """
    date_str = "2025-06-12"
    percentage_change = get_btc_price_change(date_str)
