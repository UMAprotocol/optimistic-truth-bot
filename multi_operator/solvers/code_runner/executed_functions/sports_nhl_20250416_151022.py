...
def fetch_game_data(date):
    ...
    """
    logger.info(f"Fetching game data for NBA on {date}")
    ...
    try:
        ...
        for game_data in games:
            if game_data['HomeTeam'] == 'GSW' and game_data['AwayTeam'] == 'MEM':
                return game_data
            if game_data['HomeTeam'] == 'MEM' and game_data['AwayTeam'] == 'GSW':
                return game_data

        logger.warning("No matching game found between GSW and MEM on the specified date.")
        return None
