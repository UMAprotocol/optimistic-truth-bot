...
def resolve_market():
    ...
    """
    # Define the time for the 1 hour candle beginning at 12 AM ET on June 7, 2025
    target_date = datetime(2025, 6, 7, 0, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    start_time = int(target_date.timestamp() * 1000)  # Convert to milliseconds
    end_time = start_time + 3600000  # 1 hour later

    # Fetch the candle data for BTC/USDT
