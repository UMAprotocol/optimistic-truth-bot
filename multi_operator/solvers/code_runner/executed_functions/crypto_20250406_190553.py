...
def main():
    ...
    # Output results
    print(f"BTC price on {date1} at {hour:02d}:{minute:02d} {timezone_str}: {price_1}")
    print(f"BTC price on {date2} at {hour:02d}:{minute:02d} {timezone_str}: {price_2}")
    print(f"Market resolves as: {result}")
