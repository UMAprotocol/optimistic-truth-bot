    ...
    try:
        ...
        for game_data in games:
            if game_data['HomeTeam'] == "VGK" or game_data['AwayTeam'] == "VGK":
                if game_data['HomeTeam'] == "VAN" or game_data['AwayTeam'] == "VAN":
                    logger.info("Found the game between Vegas Golden Knights and Vancouver Canucks")
                    return game_data

        logger.warning("No matching game found between Vegas Golden Knights and Vancouver Canucks on the specified date.")
        return None
