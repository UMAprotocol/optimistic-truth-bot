...
def main():
    ...
    try:
        ...
        if price_1 < price_2:
            print("Ethereum price went up from March 21 to March 22.")
            print("recommendation: p2")
        elif price_1 > price_2:
            print("Ethereum price went down from March 21 to March 22.")
            print("recommendation: p1")
        else:
            print("Ethereum price stayed the same from March 21 to March 22.")
