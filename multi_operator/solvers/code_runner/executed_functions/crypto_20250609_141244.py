...
def main():
    ...
    """
    # Define the times and dates for comparison
    date1 = "2025-05-28"
    date2 = "2025-05-29"
    hour = 12
    minute = 0
    ...
    # Get data
    close_price1 = get_data(symbol, start_time1, end_time1, proxy_url, primary_url)
    close_price2 = get_data(symbol, start_time2, end_time2, proxy_url, primary_url)
