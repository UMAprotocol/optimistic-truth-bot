...
def get_btc_price_change(date_str, hour=13, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 15, 2025 at 1 PM ET.
    """
    date_str = "2025-06-15"
    hour = 13  # 1 PM ET
    minute = 0
