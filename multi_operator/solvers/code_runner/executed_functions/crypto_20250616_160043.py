...
def resolve_market():
    ...
    target_date = datetime(2025, 6, 16, 11, 0, 0)  # June 16, 2025, 11:00 AM ET
    ...
    start_price = fetch_price_data("ETHUSDT", "1h", start_time, start_time)
    end_price = fetch_price_data("ETHUSDT", "1h", end_time, end_time)
