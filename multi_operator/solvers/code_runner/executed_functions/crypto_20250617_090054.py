...
def resolve_market(symbol, target_datetime):
    """
    Determines the market resolution based on the price change of the ETH/USDT pair at a specific datetime.
    """
...
def main():
    ...
    target_datetime = datetime(2025, 6, 17, 4, 0, tzinfo=pytz.timezone("US/Eastern"))
