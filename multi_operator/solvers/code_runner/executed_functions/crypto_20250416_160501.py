...
def main():
    ...
    """
    try:
        # Get prices for the specified dates and times
        price_apr_15 = get_close_price_at_specific_time("2025-04-15", 12, 0, "US/Eastern", "BTCUSDT")
        price_apr_16 = get_close_price_at_specific_time("2025-04-16", 12, 0, "US/Eastern", "BTCUSDT")
