...
def get_eth_price(date_str, hour=0, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to handle the Ethereum price query for June 18, 2025, 12 AM ET.
    """
    query_date = "2025-06-18"
    query_hour = 0  # 12 AM ET
    query_minute = 0
    query_timezone = "US/Eastern"

    try:
        open_price, close_price = get_eth_price(query_date, query_hour, query_minute, query_timezone)
