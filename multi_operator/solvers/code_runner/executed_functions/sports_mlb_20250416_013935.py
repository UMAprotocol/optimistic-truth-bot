...
def fetch_game_data(date):
    ...
    try:
        ...
        games = response.json()
        for game in games:
            if game['HomeTeam'] == 'CIN' and game['AwayTeam'] == 'SEA' or game['HomeTeam'] == 'SEA' and game['AwayTeam'] == 'CIN':
                return game
        return None
...
def determine_resolution(game):
    ...
    if status == "Final":
        ...
        if home_score > away_score:
            winner = "Mariners" if home_team == "SEA" else "Reds"
        else:
            winner = "Reds" if away_team == "CIN" else "Mariners"
