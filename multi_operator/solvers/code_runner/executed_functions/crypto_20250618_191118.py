...
def get_eth_price_at_specific_time(date_str, hour=14, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to handle the Ethereum price query for June 18, 2025, 2 PM ET.
    """
    date_str = "2025-06-18"
    hour = 14  # 2 PM ET
    minute = 0
    ...
    try:
        open_price, close_price = get_eth_price_at_specific_time(date_str, hour, minute, timezone_str)
