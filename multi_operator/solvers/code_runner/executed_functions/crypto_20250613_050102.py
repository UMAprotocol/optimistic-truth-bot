...
def resolve_market(symbol, target_datetime):
    ...
    Args:
        ...
        target_datetime (datetime): The datetime to check the price at.
    ...
    start_price = fetch_price_data(symbol, "1h", start_time, start_time)
    end_price = fetch_price_data(symbol, "1h", end_time, end_time)
...
def main():
    # Example usage
    symbol = "BTCUSDT"
    target_datetime = datetime(2025, 6, 13, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
