...
def get_btc_price_at_specific_time(date_str, hour=10, minute=0, timezone_str="US/Eastern"):
    """
    Fetches the 1-hour candle data for BTC/USDT on Binance at a specific time on a given date.
...
def main():
    """
    Main function to handle the resolution of the market based on BTC/USDT prices.
    """
    # Date and time for the event
    event_date = "2025-06-19"
    event_hour = 10  # 10 AM ET
