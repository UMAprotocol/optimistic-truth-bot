...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 15, 2025 at 12 AM ET.
    """
    date_str = "2025-06-15"
    hour = 0  # 12 AM ET
    timezone_str = "US/Eastern"

    price_change = get_btc_price_change(date_str, hour, timezone_str=timezone_str)
