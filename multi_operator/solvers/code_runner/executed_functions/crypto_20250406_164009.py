...
def get_close_price_at_specific_time():
    ...
    at noon on April 4, 2025 in the ET timezone.
...
def main():
    try:
        close_price = get_close_price_at_specific_time()
        threshold_price = 86000.01
        result = "p2" if close_price >= threshold_price else "p1"
        print(f"BTCUSDT close price on 2025-04-04 at 12:00 ET: {close_price}")
