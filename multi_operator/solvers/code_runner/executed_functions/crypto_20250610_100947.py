...
def fetch_binance_data(symbol, interval, start_time, end_time):
    ...
    try:
        ...
        response = requests.get(f"{PROXY_BINANCE_API}?symbol={symbol}&interval={interval}&limit=1&startTime={start_time}&endTime={end_time}", timeout=10)
...
def main():
    ...
    """
    target_datetime = datetime(2025, 6, 9, 8, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "BTCUSDT"
    change_percent = get_price_change(symbol, target_datetime)
