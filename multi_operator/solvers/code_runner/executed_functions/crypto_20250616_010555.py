...
def resolve_market():
    ...
    symbol = "ETHUSDT"
    interval = "1h"
    target_time = datetime(2025, 6, 15, 20, 0, 0)  # June 15, 2025, 8 PM ET
    ...
    start_price = fetch_price_data(symbol, interval, start_time, start_time + 60000)  # Start of the hour
    end_price = fetch_price_data(symbol, interval, end_time - 60000, end_time)  # End of the hour
