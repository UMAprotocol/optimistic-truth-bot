...
def resolve_market():
    ...
    """
    # Define the time for the 1 hour candle that begins at 6PM ET on June 8, 2025
    target_date = datetime(2025, 6, 8, 18, 0, 0, tzinfo=pytz.timezone('US/Eastern'))
    ...
    # Fetch the data for the specified candle
