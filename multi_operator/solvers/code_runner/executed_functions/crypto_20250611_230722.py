...
def get_eth_price_change(symbol, target_datetime):
    """
    Calculates the percentage change of ETH price for the specified 1-hour candle.
    """
...
def main():
    # Define the target date and time for the ETH price check
    target_datetime_str = "2025-06-11 18:00:00"
