...
def resolve_market():
    ...
    """
    # Define the time for the 1 hour candle starting at 6 AM ET on June 8, 2025
    target_date = datetime(2025, 6, 8, 6, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    ...
    try:
        start_price = fetch_price_data("BTCUSDT", "1h", start_time, start_time)
        end_price = fetch_price_data("BTCUSDT", "1h", end_time, end_time)
