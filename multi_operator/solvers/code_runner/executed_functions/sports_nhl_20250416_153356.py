...
# Constants - RESOLUTION MAPPING using NHL abbreviations
RESOLUTION_MAP = {
...
def fetch_game_data(date):
    ...
    try:
        ...
        for game_data in games:
            if game_data['HomeTeam'] == 'CHI' and game_data['AwayTeam'] == 'OTT' or game_data['HomeTeam'] == 'OTT' and game_data['AwayTeam'] == 'CHI':
