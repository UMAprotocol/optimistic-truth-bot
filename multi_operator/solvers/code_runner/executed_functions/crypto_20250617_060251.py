...
def resolve_market(symbol, target_datetime):
    """
    Determines the market resolution based on the price change of the BTC/USDT pair at a specific datetime.
    """
...
def main():
    ...
    target_datetime = datetime(2025, 6, 17, 1, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
