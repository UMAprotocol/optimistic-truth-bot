...
def check_game_status(game_date, home_team, away_team):
...
if __name__ == "__main__":
    ...
    home_team = "Rays"  # Tampa Bay Rays
    away_team = "Rangers"  # Texas Rangers
    recommendation = check_game_status(game_date, home_team, away_team)
