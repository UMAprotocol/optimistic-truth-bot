...
def get_candle_data(symbol, target_datetime):
    """
    Retrieves the closing price of a specific candle based on the given datetime.
    """
...
def main():
    ...
    if closing_price is not None:
        print(f"The closing price for the candle starting at {target_date_str} {target_time_str} ET was {closing_price}")
    else:
