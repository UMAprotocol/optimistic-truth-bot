...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 12, 2025, at 8 PM ET.
    """
    percentage_change = get_btc_price_change("2025-06-12", 20, 0, "US/Eastern")
