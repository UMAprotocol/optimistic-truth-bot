...
def get_price_change(symbol, start_time):
    """
    Calculates the price change percentage for the specified symbol and time.
    """
    ...
    if data and len(data) > 0:
        ...
        logger.error("No data available for the given parameters.")
        return None
...
def main():
    ...
    """
    symbol = "BTCUSDT"
    target_time = datetime(2025, 6, 4, 5, 0, tzinfo=pytz.timezone("US/Eastern"))
    try:
