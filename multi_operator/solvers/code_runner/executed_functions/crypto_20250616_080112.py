...
def get_eth_price_change():
    ...
    target_datetime = datetime(2025, 6, 16, 3, 0, 0, tzinfo=pytz.timezone('US/Eastern'))
    ...
    try:
        data = fetch_data_from_binance("ETHUSDT", "1h", target_timestamp, target_timestamp + 3600000)
