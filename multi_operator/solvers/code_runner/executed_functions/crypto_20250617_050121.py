...
def main():
    """
    Main function to determine if Bitcoin price went up or down on June 17, 12 AM ET.
    """
    symbol = "BTCUSDT"
    target_datetime = datetime(2025, 6, 17, 0, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
