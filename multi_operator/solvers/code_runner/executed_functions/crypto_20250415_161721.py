...
def main():
    ...
    """
    try:
        # Get prices for the specific dates and times
        price_april_14 = get_close_price_at_specific_time("2025-04-14", 12, 0, "US/Eastern", "BTCUSDT")
        price_april_15 = get_close_price_at_specific_time("2025-04-15", 12, 0, "US/Eastern", "BTCUSDT")
        
        # Determine the resolution based on the prices
        if price_april_15 > price_april_14:
            recommendation = "p2"  # Up
        elif price_april_15 < price_april_14:
        ...
        print("recommendation: p4")  # In case of any errors
