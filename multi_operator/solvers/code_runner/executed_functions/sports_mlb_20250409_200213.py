...
RESOLUTION_MAP = {
    "Detroit Tigers": "p2",  # Detroit Tigers win maps to p2
...
def determine_resolution(game):
    ...
    if status == "Final":
        if home_score > away_score:
            ...
            return "recommendation: " + RESOLUTION_MAP["New York Yankees"]
...
def main():
    date = "2025-04-09"
    home_team = "DET"  # Detroit Tigers abbreviation
    away_team = "NYY"  # New York Yankees abbreviation
