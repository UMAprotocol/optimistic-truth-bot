...
RESOLUTION_MAP = {
    "Baltimore Orioles": "p2",  # Orioles win maps to p2
    "Washington Nationals": "p1",  # Nationals win maps to p1
...
def fetch_game_data():
    ...
    """
    date = "2025-04-22"
    team1_name = "Baltimore Orioles"
    team2_name = "Washington Nationals"
