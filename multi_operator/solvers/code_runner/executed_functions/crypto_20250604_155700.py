...
def main():
    """
    Main function to determine if XRP reached $2.80 in May 2025.
    """
    result = check_xrp_price_threshold("2025-05-01 00:00", "2025-05-31 23:59", 2.80)
    if result:
        print("recommendation: p2")  # Yes, XRP reached $2.80 or higher
    else:
        print("recommendation: p1")  # No, XRP did not reach $2.80
