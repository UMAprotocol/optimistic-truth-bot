...
RESOLUTION_MAP = {
    "Astros": "p2",  # Houston Astros win maps to p2
    "Cardinals": "p1",  # St. Louis Cardinals win maps to p1
...
def determine_resolution(game):
    ...
    if status == "Final":
        ...
        if winner == "HOU":
            return "p2"  # Houston Astros win
        elif winner == "STL":
            return "p1"  # St. Louis Cardinals win
    elif status == "Canceled" or status == "Postponed":
...
def main():
    ...
    """
    date = "2025-04-14"
    team1_name = "HOU"  # Houston Astros
    team2_name = "STL"  # St. Louis Cardinals
