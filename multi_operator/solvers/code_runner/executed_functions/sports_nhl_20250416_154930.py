...
RESOLUTION_MAP = {
    "STL": "p1",  # St. Louis Blues maps to p1
    "UTA": "p2",  # Utah (hypothetical abbreviation) maps to p2
...
def main():
    ...
    """
    date = "2025-04-15"
    team1_abbr = "UTA"  # Hypothetical abbreviation for Utah
    team2_abbr = "STL"  # Abbreviation for St. Louis Blues
