...
def main():
    """
    Main function to handle the Ethereum price query for June 18, 2025, 10 AM ET.
    """
    date_str = "2025-06-18"  # Date of interest
    hour = 10  # Hour of interest in Eastern Time
    minute = 0  # Minute of interest

    try:
        open_price, close_price = get_eth_price_at_specific_time(date_str, hour, minute)
