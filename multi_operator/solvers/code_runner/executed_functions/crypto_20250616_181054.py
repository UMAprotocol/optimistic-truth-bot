...
def get_eth_price_change(date_str, hour=13, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    ...
    logger.info(f"Processing query for Ethereum price change on {query_date} at {query_hour} {query_timezone}")
    
    try:
        price_change = get_eth_price_change(query_date, query_hour, 0, query_timezone)
