...
def get_btc_price_change(date_str, hour, minute, timezone_str):
    ...
    Returns:
        Percentage change as a float or None if data cannot be retrieved.
    """
    try:
        ...
        start_time_ms = int(target_time_utc.timestamp() * 1000) - 3600000  # 1 hour before for the start of the candle
...
def main():
    """
    Main function to determine if the BTC price went up or down at a specific time.
    """
