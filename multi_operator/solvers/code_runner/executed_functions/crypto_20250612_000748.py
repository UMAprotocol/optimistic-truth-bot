...
def main():
    """
    Main function to determine if the BTC price went up or down on June 11, 2025, at 7 PM ET.
    """
    percentage_change = get_btc_price_change("2025-06-11", 19, 0, "US/Eastern")
