...
def get_eth_price_at_specific_time(date_str, hour=8, minute=0, timezone_str="US/Eastern"):
    """
...
def main():
    """
    Main function to handle the Ethereum price query for June 18, 2025, 8 AM ET.
    """
