        ...
        if game['HomeTeam'] == HOME_TEAM and game['AwayTeam'] == AWAY_TEAM:
            if game['Status'] == 'Final':
                if game['HomeTeamRuns'] > game['AwayTeamRuns']:
                    return "recommendation: p1"  # Home team (Mariners) wins
                elif game['AwayTeamRuns'] > game['HomeTeamRuns']:
                    return "recommendation: p2"  # Away team (Twins) wins
            elif game['Status'] == 'Canceled':
                return "recommendation: p3"  # Game canceled
            elif game['Status'] == 'Postponed':
                return "recommendation: p4"  # Game postponed, check later
    return "recommendation: p4"  # No final result available or game not found
