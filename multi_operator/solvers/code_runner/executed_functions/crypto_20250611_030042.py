...
def get_price_change(symbol, target_time):
    """
    Calculates the price change for the specified symbol at the target time.
    """
...
def main():
    ...
    """
    # Define the target time for the price check
    target_time_str = "2025-06-10 22:00:00"
    target_time = datetime.strptime(target_time_str, "%Y-%m-%d %H:%M:%S")
    target_time = pytz.timezone("US/Eastern").localize(target_time)

    # Symbol for Bitcoin in USDT
    symbol = "BTCUSDT"
