...
def main():
    """
    Main function to determine if the BTC/USDT price went up or down on June 12, 2025, at 8 AM ET.
    """
    percentage_change = get_btc_price_change("2025-06-12", 8, 0, "US/Eastern")
