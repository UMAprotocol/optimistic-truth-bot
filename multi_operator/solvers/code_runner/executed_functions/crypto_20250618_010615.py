...
def resolve_market(symbol, target_datetime):
    ...
    end_price = fetch_price_data(symbol, "1h", end_time_ms, end_time_ms + 60000)  # 1 minute after end
...
def main():
    # Example: Resolve the market for Ethereum on June 17, 2025, 8 PM ET
    target_datetime = datetime(2025, 6, 17, 20, 0, 0, tzinfo=pytz.timezone("US/Eastern"))
    symbol = "ETHUSDT"
