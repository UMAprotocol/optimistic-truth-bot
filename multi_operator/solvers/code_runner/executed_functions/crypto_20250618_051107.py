...
def get_sol_price_at_specific_time(date_str, hour=0, minute=0, timezone_str="US/Eastern"):
    """
    Fetches the SOL/USDT 1-hour candle data on Binance at a specific time on a given date.
...
def main():
    ...
    try:
        ...
        open_price, close_price = get_sol_price_at_specific_time(
            event_date, event_hour, event_minute, "US/Eastern"
        )
