...
def resolve_market():
    """
    Resolves the market based on the ETH/USDT price data from Binance.
    """
    # Define the time for the 1H candle on June 20, 2025, 3AM ET
    et_zone = timezone('US/Eastern')
    utc_zone = timezone('UTC')
    target_time = datetime(2025, 6, 20, 3, 0, 0, tzinfo=et_zone)
    target_time_utc = target_time.astimezone(utc_zone)
