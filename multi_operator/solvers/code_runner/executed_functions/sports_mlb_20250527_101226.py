...
def resolve_market():
    ...
    if score is None:
        ...
        print("recommendation: p2")  # Player scored more than 32.5 points, resolve to "Yes"
    else:
        print("recommendation: p1")  # Player did not score more than 32.5 points, resolve to "No"
