...
RESOLUTION_MAP = {
    "Red Sox": "p2",  # Boston Red Sox win maps to p2
    "Rays": "p1",     # Tampa Bay Rays win maps to p1
...
def main():
    ...
    """
    date = "2025-04-14"
    team1_name = "BOS"  # Boston Red Sox abbreviation
    team2_name = "TBR"  # Tampa Bay Rays abbreviation
