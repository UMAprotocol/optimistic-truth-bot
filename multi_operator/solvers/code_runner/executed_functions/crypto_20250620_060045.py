...
def resolve_market(symbol, target_time):
    """
    Resolves the market based on the price data fetched for the specified symbol at the target time.
    """
...
def main():
    # Example usage
    symbol = "BTCUSDT"
    target_time = datetime(2025, 6, 20, 1, 0)  # June 20, 2025, 1:00 AM UTC
