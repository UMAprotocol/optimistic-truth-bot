...
def resolve_market():
    ...
    event_date = datetime(2025, 5, 31, 8, 0, 0, tzinfo=pytz.timezone('US/Eastern'))
    start_time = int(event_date.timestamp() * 1000)
    end_time = int((event_date + timedelta(hours=1)).timestamp() * 1000)
