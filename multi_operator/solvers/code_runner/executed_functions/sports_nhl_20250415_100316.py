...
def fetch_nhl_game_result():
    ...
    try:
        ...
        for game in games:
            if game['HomeTeam'] == "UTA" and game['AwayTeam'] == "NSH":
                if game['Status'] == "Final":
                    if game['HomeTeamScore'] > game['AwayTeamScore']:
                        return "recommendation: p2"  # Utah wins
                    elif game['HomeTeamScore'] < game['AwayTeamScore']:
                        return "recommendation: p1"  # Predators win
    ...
    return "recommendation: p4"  # No game found or other unhandled cases
